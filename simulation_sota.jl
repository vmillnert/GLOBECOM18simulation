...
"""
function sim_graph_sota(sim_time::Int64,
                        P,
                        DAS::Bool,
                        DOA::Bool,
                        AC::Bool,
                   ...
                   N::Int64,
                   peak::Float64,
                   deadline_low::Float64, deadline_high::Float64,
    ...
    # filter constant for the sliding window filter of mref when using dynamic autoscaling
    filt = 10 
...
mref_nofilt::Array{Int64,2}     = zeros(Int64, n, N)
...
D::Array{Int64,1} = floor.(Int64, D_x.value[:,1] ./ dt)
